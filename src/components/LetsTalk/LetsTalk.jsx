...
import ResponsiveLetsTalk from "../ResponsiveComponents/ResponsiveLetsTalk/ResponsiveLetsTalk";

const LetsTalk = () => {
  return (
    <>
      <div className="bg-black h-[850px] hidden md:block">
        <div className="pt-20">
          <video
